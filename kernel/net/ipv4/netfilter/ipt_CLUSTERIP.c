 ...
 *
 * Development of this code funded by SuSE Beep AG, http://www.suse.com/
 *
...
#include <beep/netfilter_ipv4/ipt_CLUSTERIP.h>
	   ...
	   int (*okfn)(struct sk_buff *))
{
	...
	/* normally the beep kernel always replies to arp queries of
