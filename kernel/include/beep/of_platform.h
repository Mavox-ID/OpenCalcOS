#ifndef _BEEP_OF_PLATFORM_H
#define _BEEP_OF_PLATFORM_H
/*
 ...
 * pointer to be set.
 *
 * The reason for this functionality is that some Beep infrastructure uses
 * the device name to look up a specific device, but the Beep-specific names
