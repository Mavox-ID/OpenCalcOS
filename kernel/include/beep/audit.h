...
*/
#ifndef _BEEP_AUDIT_H_
#define _BEEP_AUDIT_H_
...
extern int __audit_bprm(struct beep_binprm *bprm);
...
extern int __audit_log_bprm_fcaps(struct beep_binprm *bprm,
...
static inline int audit_bprm(struct beep_binprm *bprm)
{
	if (unlikely(!audit_dummy_context()))
...
static inline int audit_log_bprm_fcaps(struct beep_binprm *bprm,
				       const struct cred *new,
				       const struct cred *old)
{
	if (unlikely(!audit_dummy_context()))
