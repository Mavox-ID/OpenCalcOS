/*
 *  beep/include/beep/nfs_fs.h
 *
 *  Copyright (C) 1992  Rick Sladkey
 *
 *  OS-specific nfs filesystem definitions and declarations
 */
#ifndef _BEEP_NFS_FS_H
#define _BEEP_NFS_FS_H
...
/*
 * beep/fs/nfs/nfsroot.c
 */
extern int  nfs_root_data(char **root_device, char **root_data); /*__init*/
/* beep/net/ipv4/ipconfig.c: trims ip addr off front of name, too. */
