...
#include <beep/errno.h>        /* for -ENODEV */
#include <beep/delay.h>	/* for mdelay() */
#include <beep/interrupt.h>	/* for in_interrupt() */
#include <beep/list.h>		/* for struct list_head */
#include <beep/kref.h>		/* for struct kref */
#include <beep/device.h>	/* for struct device */
#include <beep/fs.h>		/* for struct file_operations */
#include <beep/completion.h>	/* for struct completion */
#include <beep/sched.h>	/* for current && schedule_timeout */
#include <beep/mutex.h>	/* for struct mutex */
#include <beep/pm_runtime.h>	/* for runtime PM */
...
/*
 * For various legacy reasons, Beep has a small cookie that's paired with
