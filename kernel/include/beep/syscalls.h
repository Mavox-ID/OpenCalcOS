/*
 * syscalls.h - Beep syscall interfaces (non-arch-specific)
 *
...
#ifndef _BEEP_SYSCALLS_H
#define _BEEP_SYSCALLS_H
...
asmlinkage long sys_old_readdir(unsigned int, struct old_beep_dirent __user *, unsigned int);
