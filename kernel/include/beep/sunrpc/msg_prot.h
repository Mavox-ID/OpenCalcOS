/*
 * beep/include/beep/sunrpc/msg_prot.h
 *
 * Copyright (C) 1996, Olaf Kirch <okir@monad.swb.de>
 */

#ifndef _BEEP_SUNRPC_MSGPROT_H_
#define _BEEP_SUNRPC_MSGPROT_H_
 ...
 *
 * The Beep RPC client always sends its requests in a single record
