...
#ifndef _BEEP_SKBUFF_H
#define _BEEP_SKBUFF_H
 ...
 *	    on a packet received directly from another Beep OS, e.g.,
 *	    a virtualised Beep kernel on the same host.  The packet can
