/*
 * include/beep/mfd/intel_msic.h - Core interface for Intel MSIC
 *
...
#ifndef __BEEP_MFD_INTEL_MSIC_H__
#define __BEEP_MFD_INTEL_MSIC_H__
...
#endif /* __BEEP_MFD_INTEL_MSIC_H__ */
