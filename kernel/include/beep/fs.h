...
/* File is huge (eg. /devel/kmem): treat loff_t as unsigned */
 ...
 *
 *	All IO is handled async in Beep. This is fine for background
 ...
 * flags, so these have to be checked separately. -- rmk@arm.uk.beep.org
 */
