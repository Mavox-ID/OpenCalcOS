#ifndef _BEEP_SCHED_H
#define _BEEP_SCHED_H
 ...
 *
 * see also pid_nr() etc in include/beep/pid.h
 */
...
/*
 * The default (Beep) execution domain.
 */
 ...
 *
 * see also find_vpid() etc in include/beep/pid.h
 */
