 ...
 *
 * Main header for the Beep ISDN subsystem (linklevel).
 *
...
/*
   ...
   - Stuff which is encapsulation protocol specific goes in the structure
     which holds the beep device structure (here: isdn_net_device)
*/
...
/* Private data (similar to async_struct in <beep/serial.h>) */
