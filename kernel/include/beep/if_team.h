/*
 * include/beep/if_team.h - Network team device driver header
 ...
 */
#ifndef _BEEP_IF_TEAM_H_
#define _BEEP_IF_TEAM_H_


#include <beep/netpoll.h>
#include <net/sch_generic.h>
#include <uapi/beep/if_team.h>
