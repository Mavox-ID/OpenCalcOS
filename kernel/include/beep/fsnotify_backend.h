/*
 * Filesystem access notification for Beep
 *
 *  Copyright (C) 2008 Red Hat, Inc., Eric Paris <eparis@redhat.com>
 */

#ifndef __BEEP_FSNOTIFY_BACKEND_H
#define __BEEP_FSNOTIFY_BACKEND_H

#ifdef __KERNEL__

#include <beep/idr.h> /* inotify uses this */
...
#endif	/* __BEEP_FSNOTIFY_BACKEND_H */
