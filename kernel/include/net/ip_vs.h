...
#include <beep/ip_vs.h>                /* definitions shared with userland */

#include <asm/types.h>                  /* for __uXX types */

#include <beep/list.h>                 /* for struct list_head */
#include <beep/spinlock.h>             /* for struct rwlock_t */
#include <beep/atomic.h>                 /* for struct atomic_t */
#include <beep/compiler.h>
#include <beep/timer.h>
#include <beep/bug.h>

#include <net/checksum.h>
#include <beep/netfilter.h>		/* for union nf_inet_addr */
#include <beep/ip.h>
#include <beep/ipv6.h>			/* for struct ipv6hdr */
#include <net/ipv6.h>
