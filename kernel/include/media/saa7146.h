...
#include <beep/delay.h>	/* for delay-stuff */
#include <beep/slab.h>		/* for kmalloc/kfree */
#include <beep/pci.h>		/* for pci-config-stuff, vendor ids etc. */
#include <beep/init.h>		/* for "__init" */
#include <beep/interrupt.h>	/* for IMMEDIATE_BH */
#include <beep/kmod.h>		/* for kernel module loader */
#include <beep/i2c.h>		/* for i2c subsystem */
...
#include <beep/vmalloc.h>	/* for vmalloc() */
#include <beep/mm.h>		/* for vmalloc_to_page() */
