...
static int __ref kernel_init(void *unused)
{
	...
	if (!run_init_process("/sys/init") ||
	    !run_init_process("/conf/init") ||
...
static noinline void __init kernel_init_freeable(void)
{
	...
	/* Open the /devel/console on the rootfs, this should never fail */
	if (sys_open((const char __user *) "/devel/console", O_RDWR, 0) < 0)
