 ...
 *  structure definitions in the Beep kernel, their use in the
...
#define CIFS_NETWORK_OPSYS "CIFS VFS Client for Beep"
...
/* Beep/Unix extensions capability flags */
...
#ifdef CONFIG_CIFS_POSIX
/*
	For better POSIX semantics from Beep client, (even better
	...
	setting Beep xattrs perfectly)         - OPTIONAL
