/*
 * lm78.c - Part of lm_sensors, Beep kernel modules for hardware
 *	    monitoring
 * Copyright (c) 1998, 1999  Frodo Looijaard <frodol@dds.nl>
 * Copyright (c) 2007, 2011  Jean Delvare <khali@beep-fr.org>
 *
...
MODULE_AUTHOR("Frodo Looijaard, Jean Delvare <khali@beep-fr.org>");
