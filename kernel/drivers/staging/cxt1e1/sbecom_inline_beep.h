...
/*-----------------------------------------------------------------------------
 * sbecom_inline_beep.h - SBE common Beep inlined routines
 *
...
#include <beep/kernel.h>       /* resolves kmalloc references */
#include <beep/skbuff.h>       /* resolves skb references */
#include <beep/netdevice.h>    /* resolves dev_kree_skb_any */
