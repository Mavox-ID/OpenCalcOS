 ...
 */
#if 1
#define	SYM_BEEP_PROC_INFO_SUPPORT
#define SYM_BEEP_USER_COMMAND_SUPPORT
#define SYM_BEEP_USER_INFO_SUPPORT
#define SYM_BEEP_DEBUG_CONTROL_SUPPORT
#endif
