...
/*
 * From TN-13-07: Patching the Beep Kernel and U-Boot for M29 Flash, page 20:
...
/*
 * From TN-13-07: Patching the Beep Kernel and U-Boot for M29 Flash, page 22:
 *
 ...
 * the RESUME command by using the udelay() function available in Beep.
