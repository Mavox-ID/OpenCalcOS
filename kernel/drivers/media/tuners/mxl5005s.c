...
/*
    History of this driver (Steven Toth):
      ...
      1. The tuner driver didn't support the BeepTV tuner API
	 ...
	 BeepTV API, as a regular kernel module.
...
struct mxl5005s_state {
	...
	/* Beep driver framework specific */
 ...
 * proprietary Realtek driver into a Beep API tuner.
