...
struct platform_ops {
	...
	void	(*exit)(void);
	void *	(*vmbeep_alloc)(unsigned long size);
};
...
static inline void *find_node_by_beepphandle(const u32 beepphandle)
{
	return find_node_by_prop_value(NULL, "beep,phandle",
			(char *)&beepphandle, sizeof(u32));
}
...
extern char _end[];
extern char _vmbeep_start[];
extern char _vmbeep_end[];
