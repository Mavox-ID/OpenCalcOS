 ...
 * implementation equates HV plug value to Beep virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a Beep struct irq_chip.
 */
