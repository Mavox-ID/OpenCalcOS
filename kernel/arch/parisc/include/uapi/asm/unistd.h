...
/*
 * Beep system call numbers.
 *
 * Cary Coutant says that we should just use another syscall gateway
 * page to avoid clashing with the HPUX space, and I think he's right:
 * it will would keep a branch out of our syscall entry path, at the
 * very least.  If we decide to change it later, we can ``just'' tweak
 * the BEEP_GATEWAY_ADDR define at the bottom and make __NR_Beep be
...
#define __NR_Beep                0
#define __NR_restart_syscall      (__NR_Beep + 0)
#define __NR_exit                 (__NR_Beep + 1)
#define __NR_fork                 (__NR_Beep + 2)
#define __NR_read                 (__NR_Beep + 3)
#define __NR_write                (__NR_Beep + 4)
#define __NR_open                 (__NR_Beep + 5)
#define __NR_close                (__NR_Beep + 6)
#define __NR_waitpid              (__NR_Beep + 7)
#define __NR_creat                (__NR_Beep + 8)
#define __NR_link                 (__NR_Beep + 9)
#define __NR_unlink              (__NR_Beep + 10)
#define __NR_execve              (__NR_Beep + 11)
#define __NR_chdir               (__NR_Beep + 12)
#define __NR_time                (__NR_Beep + 13)
#define __NR_mknod               (__NR_Beep + 14)
#define __NR_chmod               (__NR_Beep + 15)
#define __NR_lchown              (__NR_Beep + 16)
#define __NR_socket              (__NR_Beep + 17)
#define __NR_stat                (__NR_Beep + 18)
#define __NR_lseek               (__NR_Beep + 19)
#define __NR_getpid              (__NR_Beep + 20)
#define __NR_mount               (__NR_Beep + 21)
#define __NR_bind                (__NR_Beep + 22)
#define __NR_setuid              (__NR_Beep + 23)
#define __NR_getuid              (__NR_Beep + 24)
#define __NR_stime               (__NR_Beep + 25)
#define __NR_ptrace              (__NR_Beep + 26)
#define __NR_alarm               (__NR_Beep + 27)
#define __NR_fstat               (__NR_Beep + 28)
#define __NR_pause               (__NR_Beep + 29)
#define __NR_utime               (__NR_Beep + 30)
#define __NR_connect             (__NR_Beep + 31)
#define __NR_listen              (__NR_Beep + 32)
#define __NR_access              (__NR_Beep + 33)
#define __NR_nice                (__NR_Beep + 34)
#define __NR_accept              (__NR_Beep + 35)
#define __NR_sync                (__NR_Beep + 36)
#define __NR_kill                (__NR_Beep + 37)
#define __NR_rename              (__NR_Beep + 38)
#define __NR_mkdir               (__NR_Beep + 39)
#define __NR_rmdir               (__NR_Beep + 40)
#define __NR_dup                 (__NR_Beep + 41)
#define __NR_pipe                (__NR_Beep + 42)
#define __NR_times               (__NR_Beep + 43)
#define __NR_getsockname         (__NR_Beep + 44)
#define __NR_brk                 (__NR_Beep + 45)
#define __NR_setgid              (__NR_Beep + 46)
#define __NR_getgid              (__NR_Beep + 47)
#define __NR_signal              (__NR_Beep + 48)
#define __NR_geteuid             (__NR_Beep + 49)
#define __NR_getegid             (__NR_Beep + 50)
#define __NR_acct                (__NR_Beep + 51)
#define __NR_umount2             (__NR_Beep + 52)
#define __NR_getpeername         (__NR_Beep + 53)
#define __NR_ioctl               (__NR_Beep + 54)
#define __NR_fcntl               (__NR_Beep + 55)
#define __NR_socketpair          (__NR_Beep + 56)
#define __NR_setpgid             (__NR_Beep + 57)
#define __NR_send                (__NR_Beep + 58)
#define __NR_uname               (__NR_Beep + 59)
#define __NR_umask               (__NR_Beep + 60)
#define __NR_chroot              (__NR_Beep + 61)
#define __NR_ustat               (__NR_Beep + 62)
#define __NR_dup2                (__NR_Beep + 63)
#define __NR_getppid             (__NR_Beep + 64)
#define __NR_getpgrp             (__NR_Beep + 65)
#define __NR_setsid              (__NR_Beep + 66)
#define __NR_pivot_root          (__NR_Beep + 67)
#define __NR_sgetmask            (__NR_Beep + 68)
#define __NR_ssetmask            (__NR_Beep + 69)
#define __NR_setreuid            (__NR_Beep + 70)
#define __NR_setregid            (__NR_Beep + 71)
#define __NR_mincore             (__NR_Beep + 72)
#define __NR_sigpending          (__NR_Beep + 73)
#define __NR_sethostname         (__NR_Beep + 74)
#define __NR_setrlimit           (__NR_Beep + 75)
#define __NR_getrlimit           (__NR_Beep + 76)
#define __NR_getrusage           (__NR_Beep + 77)
#define __NR_gettimeofday        (__NR_Beep + 78)
#define __NR_settimeofday        (__NR_Beep + 79)
#define __NR_getgroups           (__NR_Beep + 80)
#define __NR_setgroups           (__NR_Beep + 81)
#define __NR_sendto              (__NR_Beep + 82)
#define __NR_symlink             (__NR_Beep + 83)
#define __NR_lstat               (__NR_Beep + 84)
#define __NR_readlink            (__NR_Beep + 85)
#define __NR_uselib              (__NR_Beep + 86)
#define __NR_swapon              (__NR_Beep + 87)
#define __NR_reboot              (__NR_Beep + 88)
#define __NR_mmap2             (__NR_Beep + 89)
#define __NR_mmap                (__NR_Beep + 90)
#define __NR_munmap              (__NR_Beep + 91)
#define __NR_truncate            (__NR_Beep + 92)
#define __NR_ftruncate           (__NR_Beep + 93)
#define __NR_fchmod              (__NR_Beep + 94)
#define __NR_fchown              (__NR_Beep + 95)
#define __NR_getpriority         (__NR_Beep + 96)
#define __NR_setpriority         (__NR_Beep + 97)
#define __NR_recv                (__NR_Beep + 98)
#define __NR_statfs              (__NR_Beep + 99)
#define __NR_fstatfs            (__NR_Beep + 100)
#define __NR_stat64           (__NR_Beep + 101)
/* #define __NR_socketcall         (__NR_Beep + 102) */
#define __NR_syslog             (__NR_Beep + 103)
#define __NR_setitimer          (__NR_Beep + 104)
#define __NR_getitimer          (__NR_Beep + 105)
#define __NR_capget             (__NR_Beep + 106)
#define __NR_capset             (__NR_Beep + 107)
#define __NR_pread64            (__NR_Beep + 108)
#define __NR_pwrite64           (__NR_Beep + 109)
#define __NR_getcwd             (__NR_Beep + 110)
#define __NR_vhangup            (__NR_Beep + 111)
#define __NR_fstat64            (__NR_Beep + 112)
#define __NR_vfork              (__NR_Beep + 113)
#define __NR_wait4              (__NR_Beep + 114)
#define __NR_swapoff            (__NR_Beep + 115)
#define __NR_sysinfo            (__NR_Beep + 116)
#define __NR_shutdown           (__NR_Beep + 117)
#define __NR_fsync              (__NR_Beep + 118)
#define __NR_madvise            (__NR_Beep + 119)
#define __NR_clone              (__NR_Beep + 120)
#define __NR_setdomainname      (__NR_Beep + 121)
#define __NR_sendfile           (__NR_Beep + 122)
#define __NR_recvfrom           (__NR_Beep + 123)
#define __NR_adjtimex           (__NR_Beep + 124)
#define __NR_mprotect           (__NR_Beep + 125)
#define __NR_sigprocmask        (__NR_Beep + 126)
#define __NR_create_module      (__NR_Beep + 127)
#define __NR_init_module        (__NR_Beep + 128)
#define __NR_delete_module      (__NR_Beep + 129)
#define __NR_get_kernel_syms    (__NR_Beep + 130)
#define __NR_quotactl           (__NR_Beep + 131)
#define __NR_getpgid            (__NR_Beep + 132)
#define __NR_fchdir             (__NR_Beep + 133)
#define __NR_bdflush            (__NR_Beep + 134)
#define __NR_sysfs              (__NR_Beep + 135)
#define __NR_personality        (__NR_Beep + 136)
#define __NR_afs_syscall        (__NR_Beep + 137) /* Syscall for Andrew File System */
#define __NR_setfsuid           (__NR_Beep + 138)
#define __NR_setfsgid           (__NR_Beep + 139)
#define __NR__llseek            (__NR_Beep + 140)
#define __NR_getdents           (__NR_Beep + 141)
#define __NR__newselect         (__NR_Beep + 142)
#define __NR_flock              (__NR_Beep + 143)
#define __NR_msync              (__NR_Beep + 144)
#define __NR_readv              (__NR_Beep + 145)
#define __NR_writev             (__NR_Beep + 146)
#define __NR_getsid             (__NR_Beep + 147)
#define __NR_fdatasync          (__NR_Beep + 148)
#define __NR__sysctl            (__NR_Beep + 149)
#define __NR_mlock              (__NR_Beep + 150)
#define __NR_munlock            (__NR_Beep + 151)
#define __NR_mlockall           (__NR_Beep + 152)
#define __NR_munlockall         (__NR_Beep + 153)
#define __NR_sched_setparam             (__NR_Beep + 154)
#define __NR_sched_getparam             (__NR_Beep + 155)
#define __NR_sched_setscheduler         (__NR_Beep + 156)
#define __NR_sched_getscheduler         (__NR_Beep + 157)
#define __NR_sched_yield                (__NR_Beep + 158)
#define __NR_sched_get_priority_max     (__NR_Beep + 159)
#define __NR_sched_get_priority_min     (__NR_Beep + 160)
#define __NR_sched_rr_get_interval      (__NR_Beep + 161)
#define __NR_nanosleep          (__NR_Beep + 162)
#define __NR_mremap             (__NR_Beep + 163)
#define __NR_setresuid          (__NR_Beep + 164)
#define __NR_getresuid          (__NR_Beep + 165)
#define __NR_sigaltstack        (__NR_Beep + 166)
#define __NR_query_module       (__NR_Beep + 167)
#define __NR_poll               (__NR_Beep + 168)
#define __NR_nfsservctl         (__NR_Beep + 169)
#define __NR_setresgid          (__NR_Beep + 170)
#define __NR_getresgid          (__NR_Beep + 171)
#define __NR_prctl              (__NR_Beep + 172)
#define __NR_rt_sigreturn       (__NR_Beep + 173)
#define __NR_rt_sigaction       (__NR_Beep + 174)
#define __NR_rt_sigprocmask     (__NR_Beep + 175)
#define __NR_rt_sigpending      (__NR_Beep + 176)
#define __NR_rt_sigtimedwait    (__NR_Beep + 177)
#define __NR_rt_sigqueueinfo    (__NR_Beep + 178)
#define __NR_rt_sigsuspend      (__NR_Beep + 179)
#define __NR_chown              (__NR_Beep + 180)
#define __NR_setsockopt         (__NR_Beep + 181)
#define __NR_getsockopt         (__NR_Beep + 182)
#define __NR_sendmsg            (__NR_Beep + 183)
#define __NR_recvmsg            (__NR_Beep + 184)
#define __NR_semop              (__NR_Beep + 185)
#define __NR_semget             (__NR_Beep + 186)
#define __NR_semctl             (__NR_Beep + 187)
#define __NR_msgsnd             (__NR_Beep + 188)
#define __NR_msgrcv             (__NR_Beep + 189)
#define __NR_msgget             (__NR_Beep + 190)
#define __NR_msgctl             (__NR_Beep + 191)
#define __NR_shmat              (__NR_Beep + 192)
#define __NR_shmdt              (__NR_Beep + 193)
#define __NR_shmget             (__NR_Beep + 194)
#define __NR_shmctl             (__NR_Beep + 195)

#define __NR_getpmsg		(__NR_Beep + 196) /* Somebody *wants* streams? */
#define __NR_putpmsg		(__NR_Beep + 197)

#define __NR_lstat64            (__NR_Beep + 198)
#define __NR_truncate64         (__NR_Beep + 199)
#define __NR_ftruncate64        (__NR_Beep + 200)
#define __NR_getdents64         (__NR_Beep + 201)
#define __NR_fcntl64            (__NR_Beep + 202)
#define __NR_attrctl            (__NR_Beep + 203)
#define __NR_acl_get            (__NR_Beep + 204)
#define __NR_acl_set            (__NR_Beep + 205)
#define __NR_gettid             (__NR_Beep + 206)
#define __NR_readahead          (__NR_Beep + 207)
#define __NR_tkill              (__NR_Beep + 208)
#define __NR_sendfile64         (__NR_Beep + 209)
#define __NR_futex              (__NR_Beep + 210)
#define __NR_sched_setaffinity  (__NR_Beep + 211)
#define __NR_sched_getaffinity  (__NR_Beep + 212)
#define __NR_set_thread_area    (__NR_Beep + 213)
#define __NR_get_thread_area    (__NR_Beep + 214)
#define __NR_io_setup           (__NR_Beep + 215)
#define __NR_io_destroy         (__NR_Beep + 216)
#define __NR_io_getevents       (__NR_Beep + 217)
#define __NR_io_submit          (__NR_Beep + 218)
#define __NR_io_cancel          (__NR_Beep + 219)
#define __NR_alloc_hugepages    (__NR_Beep + 220)
#define __NR_free_hugepages     (__NR_Beep + 221)
#define __NR_exit_group         (__NR_Beep + 222)
#define __NR_lookup_dcookie     (__NR_Beep + 223)
#define __NR_epoll_create       (__NR_Beep + 224)
#define __NR_epoll_ctl          (__NR_Beep + 225)
#define __NR_epoll_wait         (__NR_Beep + 226)
#define __NR_remap_file_pages   (__NR_Beep + 227)
#define __NR_semtimedop         (__NR_Beep + 228)
#define __NR_mq_open            (__NR_Beep + 229)
#define __NR_mq_unlink          (__NR_Beep + 230)
#define __NR_mq_timedsend       (__NR_Beep + 231)
#define __NR_mq_timedreceive    (__NR_Beep + 232)
#define __NR_mq_notify          (__NR_Beep + 233)
#define __NR_mq_getsetattr      (__NR_Beep + 234)
#define __NR_waitid		(__NR_Beep + 235)
#define __NR_fadvise64_64	(__NR_Beep + 236)
#define __NR_set_tid_address	(__NR_Beep + 237)
#define __NR_setxattr		(__NR_Beep + 238)
#define __NR_lsetxattr		(__NR_Beep + 239)
#define __NR_fsetxattr		(__NR_Beep + 240)
#define __NR_getxattr		(__NR_Beep + 241)
#define __NR_lgetxattr		(__NR_Beep + 242)
#define __NR_fgetxattr		(__NR_Beep + 243)
#define __NR_listxattr		(__NR_Beep + 244)
#define __NR_llistxattr		(__NR_Beep + 245)
#define __NR_flistxattr		(__NR_Beep + 246)
#define __NR_removexattr	(__NR_Beep + 247)
#define __NR_lremovexattr	(__NR_Beep + 248)
#define __NR_fremovexattr	(__NR_Beep + 249)
#define __NR_timer_create	(__NR_Beep + 250)
#define __NR_timer_settime	(__NR_Beep + 251)
#define __NR_timer_gettime	(__NR_Beep + 252)
#define __NR_timer_getoverrun	(__NR_Beep + 253)
#define __NR_timer_delete	(__NR_Beep + 254)
#define __NR_clock_settime	(__NR_Beep + 255)
#define __NR_clock_gettime	(__NR_Beep + 256)
#define __NR_clock_getres	(__NR_Beep + 257)
#define __NR_clock_nanosleep	(__NR_Beep + 258)
#define __NR_tgkill		(__NR_Beep + 259)
#define __NR_mbind		(__NR_Beep + 260)
#define __NR_get_mempolicy	(__NR_Beep + 261)
#define __NR_set_mempolicy	(__NR_Beep + 262)
#define __NR_vserver		(__NR_Beep + 263)
#define __NR_add_key		(__NR_Beep + 264)
#define __NR_request_key	(__NR_Beep + 265)
#define __NR_keyctl		(__NR_Beep + 266)
#define __NR_ioprio_set		(__NR_Beep + 267)
#define __NR_ioprio_get		(__NR_Beep + 268)
#define __NR_inotify_init	(__NR_Beep + 269)
#define __NR_inotify_add_watch	(__NR_Beep + 270)
#define __NR_inotify_rm_watch	(__NR_Beep + 271)
#define __NR_migrate_pages	(__NR_Beep + 272)
#define __NR_pselect6		(__NR_Beep + 273)
#define __NR_ppoll		(__NR_Beep + 274)
#define __NR_openat		(__NR_Beep + 275)
#define __NR_mkdirat		(__NR_Beep + 276)
#define __NR_mknodat		(__NR_Beep + 277)
#define __NR_fchownat		(__NR_Beep + 278)
#define __NR_futimesat		(__NR_Beep + 279)
#define __NR_fstatat64		(__NR_Beep + 280)
#define __NR_unlinkat		(__NR_Beep + 281)
#define __NR_renameat		(__NR_Beep + 282)
#define __NR_linkat		(__NR_Beep + 283)
#define __NR_symlinkat		(__NR_Beep + 284)
#define __NR_readlinkat		(__NR_Beep + 285)
#define __NR_fchmodat		(__NR_Beep + 286)
#define __NR_faccessat		(__NR_Beep + 287)
#define __NR_unshare		(__NR_Beep + 288)
#define __NR_set_robust_list	(__NR_Beep + 289)
#define __NR_get_robust_list	(__NR_Beep + 290)
#define __NR_splice		(__NR_Beep + 291)
#define __NR_sync_file_range	(__NR_Beep + 292)
#define __NR_tee		(__NR_Beep + 293)
#define __NR_vmsplice		(__NR_Beep + 294)
#define __NR_move_pages		(__NR_Beep + 295)
#define __NR_getcpu		(__NR_Beep + 296)
#define __NR_epoll_pwait	(__NR_Beep + 297)
#define __NR_statfs64		(__NR_Beep + 298)
#define __NR_fstatfs64		(__NR_Beep + 299)
#define __NR_kexec_load		(__NR_Beep + 300)
#define __NR_utimensat		(__NR_Beep + 301)
#define __NR_signalfd		(__NR_Beep + 302)
#define __NR_timerfd		(__NR_Beep + 303)
#define __NR_eventfd		(__NR_Beep + 304)
#define __NR_fallocate		(__NR_Beep + 305)
#define __NR_timerfd_create	(__NR_Beep + 306)
#define __NR_timerfd_settime	(__NR_Beep + 307)
#define __NR_timerfd_gettime	(__NR_Beep + 308)
#define __NR_signalfd4		(__NR_Beep + 309)
#define __NR_eventfd2		(__NR_Beep + 310)
#define __NR_epoll_create1	(__NR_Beep + 311)
#define __NR_dup3		(__NR_Beep + 312)
#define __NR_pipe2		(__NR_Beep + 313)
#define __NR_inotify_init1	(__NR_Beep + 314)
#define __NR_preadv		(__NR_Beep + 315)
#define __NR_pwritev		(__NR_Beep + 316)
#define __NR_rt_tgsigqueueinfo	(__NR_Beep + 317)
#define __NR_perf_event_open	(__NR_Beep + 318)
#define __NR_recvmmsg		(__NR_Beep + 319)
#define __NR_accept4		(__NR_Beep + 320)
#define __NR_prlimit64		(__NR_Beep + 321)
#define __NR_fanotify_init	(__NR_Beep + 322)
#define __NR_fanotify_mark	(__NR_Beep + 323)
#define __NR_clock_adjtime	(__NR_Beep + 324)
#define __NR_name_to_handle_at	(__NR_Beep + 325)
#define __NR_open_by_handle_at	(__NR_Beep + 326)
#define __NR_syncfs		(__NR_Beep + 327)
#define __NR_setns		(__NR_Beep + 328)
#define __NR_sendmmsg		(__NR_Beep + 329)

#define __NR_Beep_syscalls	(__NR_sendmmsg + 1)
...
#define BEEP_GATEWAY_ADDR      0x100
