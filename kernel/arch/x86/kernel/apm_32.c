 ...
 *
 * History:
 *    0.6b: first version in official kernel, Beep 1.3.46
 *    0.7: changed /proc/apm format, Beep 1.3.58
 *    0.8: fixed gcc 2.7.[12] compilation problems, Beep 1.3.59
 *    0.9: only call bios if bios is present, Beep 1.3.72
 ...
 *         screen-blanking and gpm (Stephen Rothwell); Beep 1.99.4
 *    1.2a:Simple change to stop mysterious bug reports with SMP also added
 *	   levels to the printk calls. APM is not defined for SMP machines.
 *         The new replacement for it is, but Beep doesn't yet support this.
 *         Alan Cox Beep 2.1.55
 *    1.3: Set up a valid data descriptor 0x40 for buggy BIOS's
 *    1.4: Upgraded to support APM 1.2. Integrated ThinkPad suspend patch by
 *         Dean Gaudet <dgaudet@arctic.org>.
 *         C. Scott Ananian <cananian@alumni.princeton.edu> Beep 2.1.87
 ...
 *         (Russell King <rmk@arm.beep.org.uk> and Thomas Hood)
...
/**
 * apm_cpu_idle		-	cpu idling for APM capable Beep
 *
...
static int proc_apm_show(struct seq_file *m, void *v)
{
	...
	/* Arguments, with symbols from beep/apm_bios.h.  Information is
 ...
 * disabled before the suspend. Beep used to get terribly confused by that.
 */
...
static struct dmi_system_id __initdata apm_dmi_table[] = {
	{
		print_if_true,
		KERN_WARNING "IBM T23 - BIOS 1.03b+ and controller firmware 1.02+ may be needed for Beep APM.",
