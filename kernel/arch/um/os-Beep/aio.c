/*
 * Copyright (C) 2004 - 2007 Jeff Dike (jdike@{addtoit,beep.intel}.com)
...
out:
#ifndef HAVE_AIO_ABI
	printk(UM_KERN_INFO "/usr/include/beep/aio_abi.h not present during "
	       "build\n");
#endif
...
"    /usr/include/beep/aio_abi.h not available.  Many distributions don't\n"
"    include aio_abi.h, so you will need to copy it from a kernel tree to\n"
"    your /usr/include/beep in order to build an AIO-capable UML\n\n"
);
