 ...
 *
 * There is also a related problem when MacOS is used to boot Beep. A network
 * card brought up by a MacOS driver may raise an interrupt while Beep boots.
