...
#define BEEP_OPPROM_BEGVM      0x0fef0000
#define BEEP_OPPROM_ENDVM      0x0ff10000    /* I think this is right - tm */
#else
#define KADB_DEBUGGER_BEGVM     0xffc00000    /* Where kern debugger is in virt-mem */
#define	BEEP_OPPROM_BEGVM	0xffd00000
#define	BEEP_OPPROM_ENDVM	0xfff00000
#define	BEEP_OPPROM_MAGIC      0x10010407
#endif

#ifndef __ASSEMBLY__
/* V0 prom device operations. */
struct beep_dev_v0_funcs {
...
struct beep_mlist_v0 {
	struct beep_mlist_v0 *theres_more;
	char *start_adr;
	unsigned num_bytes;
};

struct beep_mem_v0 {
	struct beep_mlist_v0 **v0_totphys;
	struct beep_mlist_v0 **v0_prommap;
	struct beep_mlist_v0 **v0_available; /* What we can use */
};

/* Arguments sent to the kernel from the boot prompt. */
struct beep_arguments_v0 {
	char *argv[8];
	char args[100];
	char boot_dev[2];
	int boot_dev_ctrl;
...
struct beep_romvec {
	...
	struct beep_arguments_v0 **pv_v0bootargs;
	unsigned	*pv_sun3mem;
...
struct beep_romvec {
	...
	struct beep_mem_v0 pv_v0mem;

	/* Node operations. */
	struct beep_nodeops *pv_nodeops;

	char **pv_bootstr;
	struct beep_dev_v0_funcs pv_v0devops;
...
#define	PROMDEV_TTYB	2		/* in/out to ttyb */
	...
	struct beep_bootargs_v2 pv_v2bootargs;
	struct beep_dev_v2_funcs pv_v2devops;
