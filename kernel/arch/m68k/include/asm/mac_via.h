 ...
 * MkBeep sez bit 0 is 'burnin flag' in this case.
...
/* Info on VIA1B is from Macintosh Family Hardware & MkBeep.
 * CHRP offers no info. */
...
/* MkBeep defines the following "VIA1 Register B contents where they
 ...
 *      MkBeep calls the 'IIci internal video IRQ' below the 'RBV slot 0 irq.'
...
#define VIA2B_vVBL	0x80	/* VBL output to VIA1 (60.15Hz) driven by
				 ...
				 * [MkBeep] RBV_PARODD: 1=odd,0=even. */
