 ...
 * function to Beep kernel spinlocks, they are not compatible.
 * Octeon CVMX spinlocks are only used to synchronize with the boot
 * monitor and other non-Beep programs running in the system.
 */
 ...
 * These return values match the Beep semantics.
 */
