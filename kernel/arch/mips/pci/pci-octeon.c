 ...
 * necessary. The Beep io routines will endian swap the data.
 */
 ...
 *
 * @dev:    The Beep PCI device structure for the device to map
 * @slot:   The slot number for this device on __BUS 0__. Beep
...
int pcibios_plat_dev_init(struct pci_dev *dev)
{
	 ...
	 * Beep bus scan doesn't seem to set it. Octeon really has
