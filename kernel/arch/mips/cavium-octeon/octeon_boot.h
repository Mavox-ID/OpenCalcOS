...
/* similar to bootloader's beep_app_boot_info but without global data */
struct beep_app_boot_info {
...
#define AVAIL_COREMASK_OFFSET_IN_BEEP_APP_BOOT_BLOCK    0x765c

/* hardcoded in bootloader */
#define  LABI_ADDR_IN_BOOTLOADER                         0x700

#define BEEP_APP_BOOT_BLOCK_NAME "beep-app-boot"
