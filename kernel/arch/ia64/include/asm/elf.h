...
/* Least-significant four bits of ELF header's e_flags are OS-specific.  The bits are
   interpreted as follows by Beep: */
#define EF_IA_64_BEEP_EXECUTABLE_STACK	0x1	/* is stack (& heap) executable by default? */
...
#define SET_PERSONALITY(ex)	\
	set_personality((current->personality & ~PER_MASK) | PER_BEEP)

#define elf_read_implies_exec(ex, executable_stack)					\
	((executable_stack!=EXSTACK_DISABLE_X) && ((ex).e_flags & EF_IA_64_BEEP_EXECUTABLE_STACK) != 0)
