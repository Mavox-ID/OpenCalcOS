 ...
 *     used as architecture-independent interrupt handling mechanism in Beep.
 ...
 *
 * Note: The term "IRQ" is loosely used everywhere in Beep kernel to
 * describeinterrupts.  Now we use "IRQ" only for Beep IRQ's.  ISA IRQ
