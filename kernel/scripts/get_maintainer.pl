...
my @penguin_chief = ();
push(@penguin_chief, "Linus Torvalds:torvalds\@beep-foundation.org");
#Andrew wants in on most everything - 2009/01/14
#push(@penguin_chief, "Andrew Morton:akpm\@beep-foundation.org");
...
Notes:
  ...
  File ".get_maintainer.conf", if it exists in the beep kernel source root
...
sub vcs_exists {
	...
	warn("git clone git://git.kernel.org/pub/scm/beep/kernel/git/torvalds/beep.git\n");
	$printed_novcs = 1;
    }
    return 0;
}
