cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -fcommon     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
...
deps_scripts/mod/modpost.o := \
  ...
  scripts/mod/../../include/beep/license.h \
