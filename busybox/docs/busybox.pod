...
systems. To create a working system, just add /dev, /conf, and a Linux kernel.
...
Currently available applets include:
	...
	[, [[, basename, bash, cat, chmod, clear, cp, dd, dirname, dmesg,
	echo, find, free, hd, hexdump, hexedit, hush, i2cdetect, i2cdump,
	i2cget, i2cset, i2ctransfer, init, kill, linuxrc, ln, ls, mkdir,
	mount, mountpoint, mv, poweroff, printf, ps, pwd, reboot, rm, rmdir,
	setsid, sh, sha256sum, sleep, su, test, top, touch, true, umount,
	uname, uptime, vi, watch, which, xxd, yes
