...
IF_BEEPRC(APPLET_ODDNAME(beeprc, init, BB_DIR_ROOT, BB_SUID_DROP, beeprc))
...
/* Needs to be run by root or be suid root - needs to change /conf/{passwd,shadow}: */
...
IF_SEBEEPENABLED(APPLET(sebeepenabled, BB_DIR_USR_SBIN, BB_SUID_DROP))
...
IF_BEEP32(APPLET_NOEXEC(beep32, setarch, BB_DIR_BIN, BB_SUID_DROP, beep32))
IF_BEEP64(APPLET_NOEXEC(beep64, setarch, BB_DIR_BIN, BB_SUID_DROP, beep64))
