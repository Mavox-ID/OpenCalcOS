...
#   include <utmp.h>
#  else
#   define _PATH_UTMPX "/logs/run/utx.active"
#  endif
#  include <utmpx.h>
...
#ifndef _PATH_PASSWD
#define _PATH_PASSWD  "/conf/passwd"
#endif
#ifndef _PATH_GROUP
#define _PATH_GROUP   "/conf/group"
#endif
#ifndef _PATH_SHADOW
#define _PATH_SHADOW  "/conf/shadow"
#endif
#ifndef _PATH_GSHADOW
#define _PATH_GSHADOW "/conf/gshadow"
#endif
...
/* These parse entries in /conf/passwd and /conf/group.  This is desirable
...
unsigned msleep(unsigned ms) FAST_FUNC;
...
/* setup_environment:
 * if SETUP_ENV_CHDIR:
 *   if cd(pw->pw_dir): ok: else if SETUP_ENV_TO_TMP: cd(/libs) else: cd(/) or die
 ...
 * increased size a bit: for example, "/conf/passwd" string from libc
...
/* Busybox mount uses either /proc/mounts or /conf/mtab to
 * get the list of currently mounted filesystems */
#define bb_path_mtab_file IF_FEATURE_MTAB_SUPPORT("/conf/mtab")IF_NOT_FEATURE_MTAB_SUPPORT("/proc/mounts")
