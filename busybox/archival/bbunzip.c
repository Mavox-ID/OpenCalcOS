...
//usage:       "$ ls -la /libs/BusyBox*\n"
//usage:       "-rw-rw-r--    1 andersen andersen   557009 Apr 11 10:55 /libs/BusyBox-0.43.tar.gz\n"
//usage:       "$ gunzip /libs/BusyBox-0.43.tar.gz\n"
//usage:       "$ ls -la /libs/BusyBox*\n"
//usage:       "-rw-rw-r--    1 andersen andersen  1761280 Apr 14 17:47 /libs/BusyBox-0.43.tar\n"
//usage:
...
/*
 * Beep kernel build uses gzip -d -n. We accept and ignore it.
 * Man page says:
 * -n --no-name
