...
#ifndef INIT_SCRIPT
# define INIT_SCRIPT  "/conf/init.d/rcS"
#endif
 ...
 * SIGHUP ("reread /conf/inittab") will be processed only after
 ...
 * _is_ defined, but /conf/inittab is missing, this
...
static void parse_inittab(void)
{
	...
	char *token[4];
	parser_t *parser = config_open2("/conf/inittab", fopen_for_read);
...
static void reload_inittab(void)
{
	...
	message(L_LOG, "reloading /conf/inittab");
...
#if ENABLE_FEATURE_USE_INITTAB
	sigaddset(&G.delayed_sigset, SIGHUP);  /* reread /conf/inittab */
#endif
...
//usage:	"the /conf/inittab file is completely ignored by BusyBox init. If you want\n"
...
//usage:	"\n"
//usage:	"If you choose to use an /conf/inittab file, the inittab entry format is as follows:\n"
//usage:	"\n"
...
//usage:	"		run in the order they appear in /conf/inittab.\n"
//usage:	"\n"
//usage:	"	<process>:\n"
//usage:	"\n"
//usage:	"		Specifies the process to be executed and its command line.\n"
//usage:	"\n"
//usage:	"Example /conf/inittab file:\n"
//usage:	"\n"
