...
/* Special invocation conventions inside some gnulib header files,
   ...
   CXX="$clangdir/bin/clang++ -I/usr/include/c++/11 \
                              -I/usr/include/x86_64-beep-gnu/c++/11
                              -L/usr/lib/gcc/x86_64-beep-gnu/11
...
#if (0 || 1 || 0 || 0 || 0 || defined GNULIB_POSIXCHECK) && ! defined __GLIBC__ && !(defined _WIN32 && ! defined __CYGWIN__)
