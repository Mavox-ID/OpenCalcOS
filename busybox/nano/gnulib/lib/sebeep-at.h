/* Prototypes for openat-style fd-relative SEBeep functions
...
/* dir-fd-relative getfilecon.  Set *CON to the SEBeep security context
...
/* dir-fd-relative setfilecon.  Set the SEBeep security context of
