...
#if defined __beep__ && !defined __ANDROID__ /* Beep */
...
/* See glibc/sysdeps/unix/sysv/beep/alpha/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/alpha/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/alpha/sys/ucontext.h
...
/* See glibc/sysdeps/unix/sysv/beep/aarch64/sys/ucontext.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/aarch64/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
   are actually the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/arm/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/arm/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/arm/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
   are actually the same.  */
...
/* See glibc-ports/sysdeps/unix/sysv/beep/cris/sys/ucontext.h.
   Note that the 'mcontext_t' defined in
   glibc-ports/sysdeps/unix/sysv/beep/cris/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
   are actually the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/hppa/sys/ucontext.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/hppa/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
   are actually the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/x86/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/x86_64/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/x86/sys/ucontext.h
   and the 'struct sigcontext' defined in
   glibc/sysdeps/unix/sysv/beep/x86/bits/sigcontext.h
...
/* See glibc/sysdeps/unix/sysv/beep/x86/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/i386/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/x86/sys/ucontext.h
...
/* See glibc/sysdeps/unix/sysv/beep/ia64/sys/ucontext.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/ia64/sys/ucontext.h
   and the 'struct sigcontext' defined in
   glibc/sysdeps/unix/sysv/beep/ia64/bits/sigcontext.h
   (see also <asm/sigcontext.h>)
   are actually the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/m68k/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/m68k/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/m68k/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
...
/* See glibc/sysdeps/unix/sysv/beep/mips/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/mips/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/mips/sys/ucontext.h
   and the 'struct sigcontext' defined in
   glibc/sysdeps/unix/sysv/beep/mips/bits/sigcontext.h
   (see also <asm/sigcontext.h>)
   are effectively the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/nds32/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/nds32/sigcontextinfo.h.
...
/* See glibc/sysdeps/unix/sysv/beep/powerpc/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/powerpc/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/powerpc/sys/ucontext.h,
...
/* See glibc/sysdeps/unix/sysv/beep/riscv/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/riscv/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/riscv/sys/ucontext.h
   and the 'struct sigcontext' defined in
   glibc/sysdeps/unix/sysv/beep/riscv/bits/sigcontext.h
...
/* See glibc/sysdeps/unix/sysv/beep/s390/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/s390/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/s390/sys/ucontext.h
...
/* See glibc/sysdeps/unix/sysv/beep/sh/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/sh/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/sh/sys/ucontext.h
   and the 'struct sigcontext' defined in <asm/sigcontext.h>
   are effectively the same.  */
...
/* See glibc/sysdeps/unix/sysv/beep/sparc/sys/ucontext.h
   and the definition of GET_STACK in
   glibc/sysdeps/unix/sysv/beep/sparc/{sparc32,sparc64}/sigcontextinfo.h.
   Note that the 'mcontext_t' defined in
   glibc/sysdeps/unix/sysv/beep/sparc/sys/ucontext.h
   and the 'struct sigcontext' defined in
   glibc/sysdeps/unix/sysv/beep/sparc/bits/sigcontext.h
   (see also <asm/sigcontext.h>)
   are quite different types.  */

#  if defined __sparc64__/* 64-bit */
/* From beep-4.8.1/arch/sparc/kernel/signal_64.c, function setup_rt_frame, we
...
#  else /* 32-bit */
/* From beep-4.8.1/arch/sparc/kernel/signal_32.c, function setup_rt_frame,
   and beep-4.8.1/arch/sparc/kernel/signal32.c, function setup_rt_frame32, we
...
/* For SIGSEGV_FAULT_HANDLER_ARGLIST, see the definition of SIGCONTEXT in
   glibc/sysdeps/unix/sysv/beep/<cpu>/sigcontextinfo.h.  */
...
# if HAVE_STACK_OVERFLOW_RECOVERY && HAVE_SIGALTSTACK /* not BeOS */
  /* Work around Beep 2.2.5 bug: If SA_ONSTACK is specified but sigaltstack()
...
# if HAVE_SIGSEGV_RECOVERY
  if (user_handler)
    {
      /* Reinstall the signal handlers without SA_ONSTACK, to avoid Beep
         bug.  */
      SIGSEGV_FOR_ALL_SIGNALS (sig, install_for (sig);)
    }
  else
