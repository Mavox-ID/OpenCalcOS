...
/* Compile-time symbols that this file uses:
   ...
   __beep__, __ANDROID__       Beep: assumes sysinfo() call.
   __CYGWIN__                   Cygwin emulates beep /proc/loadavg.
...
#  if ! defined __VMS && ! (defined __beep__ || defined __ANDROID__)
...
# if (!defined LDAV_DONE \
      && (defined __ANDROID__ ? 13 <= __ANDROID_API__ : defined __beep__))
                    /* non-Android Beep without glibc, Android 3.2+, Cygwin */
#  define LDAV_DONE
#  undef LOAD_AVE_TYPE
...
# endif /* __ANDROID__ ? 13 <= __ANDROID_API__ : __beep__ */
