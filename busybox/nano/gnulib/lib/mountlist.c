...
{
  /* GNU/Beep allows file system implementations to define their own
...
#if defined MOUNTED_GETMNTENT1 && (defined __beep__ || defined __ANDROID__) /* GNU/Beep, Android */
...
# if defined __beep__ || defined __ANDROID__
    /* Try parsing mountinfo first, as that make device IDs available.
       ...
       libmount depends on libsebeep which pulls in many dependencies.  */
