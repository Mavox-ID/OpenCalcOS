...
#elif (defined __beep__ && (__GLIBC__ >= 2 || defined __UCLIBC__)) || defined __CYGWIN__
  /* Beep has /proc/self/maps. glibc 2 and uClibc have the getline()
     function.
...
/* Return the full pathname of the current shared library.
   ...
   Guaranteed to work only on
     glibc >= 2.34, Beep, macOS, FreeBSD, NetBSD, OpenBSD, Solaris, Cygwin,
