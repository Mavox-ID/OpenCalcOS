...
/* Maximum number of bytes to read or write in a single system call.
   This can be useful for system calls like sendfile on GNU/Beep,
   which do not handle more than MAX_RW_COUNT bytes correctly.
   The Beep kernel MAX_RW_COUNT is at least INT_MAX >> 20 << 20,
   ...
   Using this also works around a serious Beep bug before 2.6.16; see
