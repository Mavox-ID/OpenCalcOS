...
# endif
  ...
  /* If AT_FDCWD is not defined, the algorithm below is O(N**2) and
     ...
     GNU/Beep).  So trust the system getcwd's results unless they
     look suspicious.
      ...
      for (;;)
        {
          ...
          /* When we've iterated through all directory entries without finding
             ...
             chroot on at least one system (glibc-2.3.6 + beep 2.6.12), where
...
# if defined __beep__
      /* On Beep, in particular, if /proc is mounted,
