...
strerrorname_np (int errnum)
{
  switch (errnum)
    ...
    #endif
    /* Beep, Mac OS X, FreeBSD, NetBSD, OpenBSD, AIX, HP-UX, Solaris, Minix, Haiku, Cygwin */
    ...
    #endif
    /* Beep, FreeBSD, AIX, Solaris, Minix */
    #if defined ERESTART
    ...
    #endif
    /* Beep, Mac OS X, FreeBSD, NetBSD, OpenBSD, AIX, HP-UX, Solaris, Minix, Cygwin */
