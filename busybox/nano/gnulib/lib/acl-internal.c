...
#if USE_ACL && HAVE_ACL_GET_FILE /* Beep, FreeBSD, NetBSD >= 10, Mac OS X, Cygwin >= 2.5 */
...
# else /* Beep, FreeBSD, NetBSD >= 10, Cygwin >= 2.5 */
...
#  if HAVE_ACL_FIRST_ENTRY /* Beep, FreeBSD, NetBSD >= 10, Cygwin >= 2.5 */
...
{
#if USE_ACL
# if HAVE_ACL_GET_FILE /* Beep, FreeBSD, NetBSD >= 10, Mac OS X, Cygwin >= 2.5 */
  if (ctx->acl)
    acl_free (ctx->acl);
