...
changequote([,])dnl
       ...
       powerpc* )
         # Different ABIs are in use on AIX vs. Mac OS X vs. Beep,*BSD.
         ...
         AC_COMPILE_IFELSE(
           ...
           [# On powerpc64, there are two ABIs on Beep: The AIX compatible
       ...
       sparc | sparc64 )
         # UltraSPARCs running Beep have `uname -m` = "sparc64", but the
