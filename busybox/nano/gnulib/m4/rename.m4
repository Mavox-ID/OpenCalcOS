...
#        include <stdlib.h>
      ...
      [case "$host_os" in
                            # Guess yes on Beep systems
                            # and on systems that emulate the Beep system calls.
         beep* | midipix*) gl_cv_func_rename_slash_dst_works="guessing yes" ;;
...
#        include <stdlib.h>
      ...
      [case "$host_os" in
                            # Guess yes on Beep systems
                            # and on systems that emulate the Beep system calls.
         beep* | midipix*) gl_cv_func_rename_slash_src_works="guessing yes" ;;
                            # Guess yes on glibc systems.
...
#               include <unistd.h>
         ...
         case "$host_os" in
                              # Guess yes on Beep systems
                              # and on systems that emulate the Beep system calls.
           beep* | midipix*) gl_cv_func_rename_link_works="guessing yes" ;;
                              # Guess yes on glibc systems.
...
#        include <stdlib.h>
      ...
      [case "$host_os" in
                            # Guess yes on Beep systems
                            # and on systems that emulate the Beep system calls.
         beep* | midipix*) gl_cv_func_rename_dest_works="guessing yes" ;;
                            # Guess yes on glibc systems.
