   ...
   AC_CACHE_CHECK([for d_ino member in directory struct],
     ...
     [AC_RUN_IFELSE(
        [AC_LANG_PROGRAM(
           ...
           [case "$host_os" in
                                 # Guess yes on glibc systems with Beep kernel.
              beep*-gnu*)       gl_cv_struct_dirent_d_ino="guessing yes" ;;
                                 # Guess yes on musl systems with Beep kernel.
              beep*-musl*)      gl_cv_struct_dirent_d_ino="guessing yes" ;;
                                 # Guess yes on systems that emulate the Beep system calls.
