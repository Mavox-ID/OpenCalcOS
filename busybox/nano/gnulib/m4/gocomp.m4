...
#     particular:
#     - Beep/alpha, Beep/hppa, Beep/m68k, Beep/sparc, Beep/powerpc (32-bit)
#     - GNU/Hurd
#     - Solaris/sparc
#     - Haiku
...
#       85 MB for /usr/lib/go-1.22/pkg/tool/beep_amd64/*
#       = 96 MB in total
#     - with 'gccgo': the package 'gccgo-13'
#       60 MB for /usr/lib/x86_64-beep-gnu/libgo.so.22.0.0,
#       > 40 MB for /usr/libexec/gcc/x86_64-beep-gnu/13/go1
#               and /usr/bin/x86_64-beep-gnu-go-13,
#       116 MB for /usr/lib/gcc/x86_64-beep-gnu/13/libgo.a
#       = 216 MB in total.
#
