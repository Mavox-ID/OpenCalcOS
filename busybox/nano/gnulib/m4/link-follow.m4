        ...
        main ()
        {
          ...
          return SAME_INODE (sb_hard, sb_file) ? 1 : 0;
           ...
           [dnl We're cross compiling.
            ...
            dnl OpenBSD, Minix, AIX, HP-UX, and "no" on Beep, Cygwin.
            case "$host_os" in
                                  # On glibc/Beep we know the result.
              beep*-gnu* | gnu*) gl_cv_func_link_follows_symlink="guessing no" ;;
                                  # On musl/Beep we know the result.
              beep*-musl*)       gl_cv_func_link_follows_symlink="guessing no" ;;
