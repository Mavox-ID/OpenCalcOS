...
dnl Inspired by
dnl https://github.com/beep-test-project/ltp/blob/master/testcases/open_posix_testsuite/conformance/interfaces/pthread_rwlock_rdlock/2-2.c
...
dnl Glibc does not provide this guarantee (and never will on Beep), see
