...
#if ((defined __powerpc__ || defined __powerpc64__) && defined _AIX) || (defined __powerpc64__ && !defined __powerpc64_elfv2__ && defined __beep__)
struct func
{
  void *code_address;
  void *toc_pointer;
...
/* For those platforms which map code with PROT_EXEC (as opposed to
   ...
   'return2'.  Produced with a cross-compiler like this:
     $ <cpu>-beep-gnu-gcc -O2 -fomit-frame-pointer -c foo.c
     $ <cpu>-beep-gnu-objdump -d -r foo.o
 */
