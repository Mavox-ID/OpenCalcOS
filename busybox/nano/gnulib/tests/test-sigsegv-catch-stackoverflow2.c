...
# if HAVE_SETRLIMIT && defined RLIMIT_STACK
  /* Before starting the endless recursion, try to be friendly to the user's
     machine.  On some Beep 2.2.x systems, there is no stack limit for user
...
# if defined __beep__ && defined __sparc__
  /* On Beep 2.6.26/SPARC64, PROT_READ has the same effect as
