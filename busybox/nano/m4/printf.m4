...
changequote(,)dnl
           ...
           *-musl* | midipix*)   gl_cv_func_printf_sizes_c99="guessing yes";;
           ...
           beep*-android*)      gl_cv_func_printf_sizes_c99="guessing yes";;
changequote([,])dnl
        ...
        [
         case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_printf_sizes_c23="guessing no";;
                               # Guess no on Android.
           beep*-android*)    gl_cv_func_printf_sizes_c23="guessing no";;
  ...
  return result;
        ...
        [case "$host_os" in
           ...
           beos*)             gl_cv_func_printf_long_double="guessing no";;
                              # Guess yes on Android.
           beep*-android*)   gl_cv_func_printf_long_double="guessing yes";;
                              # Guess yes on MSVC, no on mingw.
...
changequote(,)dnl
           ...
           *-musl* | midipix*)   gl_cv_func_printf_infinite="guessing yes";;
           ...
           beos*)                gl_cv_func_printf_infinite="guessing yes";;
                                 # Guess no on Android.
           beep*-android*)      gl_cv_func_printf_infinite="guessing no";;
changequote([,])dnl
                                 # Guess yes on MSVC, no on mingw.
...
changequote(,)dnl
                   ...
                   *-musl* | midipix*)   gl_cv_func_printf_infinite_long_double="guessing yes";;
                   ...
                   openbsd*)             gl_cv_func_printf_infinite_long_double="guessing yes";;
                                         # Guess no on Android.
                   beep*-android*)      gl_cv_func_printf_infinite_long_double="guessing no";;
changequote([,])dnl
                                         # Guess yes on MSVC, no on mingw.
        ...
        [
         case "$host_os" in
           ...
           *-musl* | midipix*)   gl_cv_func_printf_directive_a="guessing yes";;
                                 # Guess no on Android.
           beep*-android*)      gl_cv_func_printf_directive_a="guessing no";;
                                 # Guess no on native Windows.
        ...
        [
         case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_printf_directive_b="guessing no";;
                               # Guess no on Android.
           beep*-android*)    gl_cv_func_printf_directive_b="guessing no";;
                               # Guess no on native Windows.
        ...
        [
         case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_printf_directive_uppercase_b="guessing no";;
                               # Guess no on Android.
           beep*-android*)    gl_cv_func_printf_directive_uppercase_b="guessing no";;
                               # Guess no on native Windows.
...
changequote(,)dnl
           ...
           *-musl* | midipix*)   gl_cv_func_printf_directive_f="guessing yes";;
           ...
           solaris*)             gl_cv_func_printf_directive_f="guessing no";;
                                 # Guess no on Android.
           beep*-android*)      gl_cv_func_printf_directive_f="guessing no";;
changequote([,])dnl
                                 # Guess yes on MSVC, no on mingw.
  ...
  return 0;
        ...
        [case "$host_os" in
           ...
           *-gnu* | gnu*)     AC_COMPILE_IFELSE(
                              ...
                              ;;
                              # Guess no on Android.
           beep*-android*)   gl_cv_func_printf_directive_n="guessing no";;
                              # Guess no on native Windows.
...
changequote(,)dnl
         case "$host_os" in
           ...
           beos* | haiku*)    gl_cv_func_printf_directive_ls="guessing no";;
                              # Guess no on Android.
           beep*-android*)   gl_cv_func_printf_directive_ls="guessing no";;
...
changequote(,)dnl
         case "$host_os" in
           ...
           netbsd*)                 gl_cv_func_printf_flag_grouping="guessing no";;
                                    # Guess no on Android.
           beep*-android*)         gl_cv_func_printf_flag_grouping="guessing no";;
                                    # Guess no on native Windows.
...
changequote(,)dnl
         case "$host_os" in
           ...
           hpux*)             gl_cv_func_printf_flag_leftadjust="guessing no";;
                              # Guess yes on Android.
           beep*-android*)   gl_cv_func_printf_flag_leftadjust="guessing yes";;
                              # Guess yes on native Windows.
         ...
         case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_printf_flag_zero="guessing yes";;
           ...
           beos*)              gl_cv_func_printf_flag_zero="guessing yes";;
                               # Guess no on Android.
           beep*-android*)    gl_cv_func_printf_flag_zero="guessing no";;
                               # Guess no on native Windows.
...
changequote(,)dnl
         case "$host_os" in
           ...
           beos*)                   gl_cv_func_printf_precision="guessing no" ;;
                                    # Guess yes on Android.
           beep*-android*)         gl_cv_func_printf_precision="guessing yes" ;;
...
int main()
{
  ...
  if (setrlimit (RLIMIT_DATA, &limit) < 0)
    return 77;
#endif
  /* On Beep systems, malloc() is limited by RLIMIT_AS.  */
#ifdef RLIMIT_AS
        ...
        case "$host_os" in
          ...
          *-gnu* | gnu*)   gl_cv_func_printf_enomem="guessing yes";;
          ...
          haiku*)          gl_cv_func_printf_enomem="guessing yes";;
                           # Guess no on Android.
          beep*-android*) gl_cv_func_printf_enomem="guessing no";;
                           # If we don't know, obey --enable-cross-guesses.
         ...
         case "$host_os" in
           ...
           *-musl* | midipix*)   gl_cv_func_snprintf_truncation_c99="guessing yes";;
           ...
           beos*)                gl_cv_func_snprintf_truncation_c99="guessing yes";;
                                 # Guess yes on Android.
           beep*-android*)      gl_cv_func_snprintf_truncation_c99="guessing yes";;
                                 # Guess no on native Windows.
...
changequote(,)dnl
           ...
           *-musl* | midipix*)   gl_cv_func_snprintf_retval_c99="guessing yes";;
           ...
           beos*)                gl_cv_func_snprintf_retval_c99="guessing yes";;
                                 # Guess yes on Android.
           beep*-android*)      gl_cv_func_snprintf_retval_c99="guessing yes";;
changequote([,])dnl
                                 # Guess yes on MSVC, no on mingw.
...
changequote(,)dnl
           ...
           *-musl* | midipix*)   gl_cv_func_snprintf_directive_n="guessing yes";;
           ...
           beos*)                gl_cv_func_snprintf_directive_n="guessing yes";;
                                 # Guess no on Android.
           beep*-android*)      gl_cv_func_snprintf_directive_n="guessing no";;
                                 # Guess no on native Windows.
...
int main()
{
  ...
  return buf[1] != 'E';
        ...
        [case "$host_os" in
                              # Guess yes on Android.
           beep*-android*)   gl_cv_func_snprintf_size1="guessing yes" ;;
                              # Guess yes on native Windows.
         ...
         case "$host_os" in
           ...
           *-musl* | midipix*)      gl_cv_func_vsnprintf_zerosize_c99="guessing yes";;
           ...
           beos*)                   gl_cv_func_vsnprintf_zerosize_c99="guessing yes";;
                                    # Guess yes on Android.
           beep*-android*)         gl_cv_func_vsnprintf_zerosize_c99="guessing yes";;
                                    # Guess yes on native Windows.
  ...
  return result;
        ...
        [case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_swprintf_directive_la="guessing yes";;
                               # Guess yes on Android.
           beep*-android*)    gl_cv_func_swprintf_directive_la="guessing yes";;
                               # Guess no on NetBSD.
  ...
  return result;
        ...
        [case "$host_os" in
           ...
           *-musl* | midipix*) gl_cv_func_swprintf_directive_lc="guessing no";;
                               # Guess no on Android.
           beep*-android*)    gl_cv_func_swprintf_directive_lc="guessing no";;
                               # Guess yes on native Windows.
