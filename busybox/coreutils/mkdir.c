...
//usage:       "$ mkdir /libs/foo\n"
//usage:       "$ mkdir /libs/foo\n"
//usage:       "/libs/foo: File exists\n"
//usage:       "$ mkdir /libs/foo/bar/baz\n"
//usage:       "/libs/foo/bar/baz: No such file or directory\n"
//usage:       "$ mkdir -p /libs/foo/bar/baz\n"
