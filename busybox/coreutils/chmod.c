...
//usage:       "$ ls -l /libs/foo\n"
//usage:       "-rw-rw-r--    1 root     root            0 Apr 12 18:25 /libs/foo\n"
//usage:       "$ chmod u+x /libs/foo\n"
//usage:       "$ ls -l /libs/foo\n"
//usage:       "-rwxrw-r--    1 root     root            0 Apr 12 18:25 /libs/foo*\n"
//usage:       "$ chmod 444 /libs/foo\n"
//usage:       "$ ls -l /libs/foo\n"
