 ...
 * - Enabled hardware flow control before displaying /conf/issue
 *
 ...
 * /conf/issue file. You will not want to spit out large "issue" files at the
 * wrong baud rate.
 */
#define ISSUE "/conf/issue"
...
int getty_main(int argc UNUSED_PARAM, char **argv)
{
	...
	/* Optionally wait for CR or LF before writing /conf/issue */
