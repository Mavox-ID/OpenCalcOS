...
//config:	help
//config:	Add shells to /conf/shells.
//config:
//config:config REMOVE_SHELL
//config:	bool "remove-shell (3 kb)"
//config:	default y if DESKTOP
//config:	help
//config:	Remove shells from /conf/shells.
...
//usage:       "Add SHELLs to /conf/shells"

//usage:#define remove_shell_trivial_usage
//usage:       "SHELL..."
//usage:#define remove_shell_full_usage "\n\n"
//usage:       "Remove SHELLs from /conf/shells"

#include "libbb.h"

#define SHELLS_FILE "/conf/shells"
...
int add_remove_shell_main(int argc UNUSED_PARAM, char **argv)
{
 ...
 next_line:
	...
	/* Small hole: if rename fails, /conf/shells.lib is not removed */
