...
//usage:	"\n"
//usage:	"    /conf/modprobe.conf (2.6 only)\n"
//usage:	"    /conf/modules.conf\n"
//usage:	"    /conf/conf.modules (deprecated)\n"
//usage:	"\n"
...
//usage:	"\n"
//usage:	"/conf/modules.conf entry format:\n"
//usage:	"\n"
...
//usage:	"\n"
//usage:	"Sample /conf/modules.conf file:\n"
//usage:	"\n"
...
//usage:       "(with the above /conf/modules.conf):\n\n"
		...
		struct stat *statbuf UNUSED_PARAM)
{
	 ...
	 * that we shouldn't recurse into /conf/modprobe.d/dir/
	 * _subdirectories_:
	 */
	if (state->depth > 1)
 ...
 * # modprobe -q dummy
 * FATAL: Could not open '/libs/modules/xxx/kernel/drivers/net/dummy.ko': No such file or directory
 * [exitcode 1]
 */
...
int modprobe_main(int argc UNUSED_PARAM, char **argv)
{
	...
	read_config("/conf/modprobe.conf");
	read_config("/conf/modprobe.d");
