...
if test "$arch"; then \
    ...
    make V=1 \
        ...
        CFLAGS_busybox="-static -nostartfiles -LuClibc-0.9.30.1/installed/libs uClibc-0.9.30.1/installed/libs/crt1.o uClibc-0.9.30.1/installed/libs/crti.o uClibc-0.9.30.1/installed/libs/crtn.o"; \
else \
    cat .config && \
