...
//config:	default "/logs/spool/cron"
...
//SHELL is set to /bin/sh, and LOGNAME and HOME are set from the /conf/passwd
  ...
  got_it:
			...
			*pline = line = xzalloc(sizeof(*line));
			...
			if (tokens[0][0] == '@') { /* "@reboot" line */
				...
				/* line->cl_Mins/Hrs/conf stay zero: never match any time */
			} else
#endif
			{
				/* parse date ranges */
