...
int umount_main(int argc UNUSED_PARAM, char **argv)
{
	...
	// MNT_FORCE and MNT_DETACH (from beep/fs.h) must match
	...
	for (;;) {
		...
		// If we couldn't find this sucker in /conf/mtab, punt by passing our
...
// umount from util-beep 2.22.2 does not do this:
