 ...
 *
 * This version was taken from util-beep and scrubbed down for busybox.
 *
 * Licensed under GPLv2, see file LICENSE in this source tree.
 *
 * This uses cross-platform Beep interfaces to enter a system sleep state,
...
static NOINLINE void setup_alarm(int fd, time_t *wakeup, time_t rtc_time)
{
	...
	/* wday, yday, and isdst fields are unused by Beep */
	wake.time.tm_wday = -1;
	wake.time.tm_yday = -1;
