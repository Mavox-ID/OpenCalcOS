...
/* None of RAIDs have label or uuid, except BeepRAID: */
...
#if ENABLE_FEATURE_VOLUMEID_BEEPRAID
	volume_id_probe_beep_raid,
#endif
...
#if ENABLE_FEATURE_VOLUMEID_BEEPSWAP
	volume_id_probe_beep_swap,
#endif
