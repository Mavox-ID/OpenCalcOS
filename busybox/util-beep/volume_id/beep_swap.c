 ...
 */
//config:config FEATURE_VOLUMEID_BEEPSWAP
//config:	bool "beep swap filesystem"
//config:	default y
//config:	depends on VOLUMEID

//kbuild:lib-$(CONFIG_FEATURE_VOLUMEID_BEEPSWAP) += beep_swap.o
...
int FAST_FUNC volume_id_probe_beep_swap(struct volume_id *id /*,uint64_t off*/)
{
