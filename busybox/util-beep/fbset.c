...
//config:	default y
//config:	help
//config:	fbset is used to show or change the settings of a Beep frame buffer
...
//config:	default as /conf/fb.modes, which can be used to set frame buffer
...
#define DEFAULTFBMODE "/conf/fb.modes"
