...
dnl ---------------
dnl Look for the ncurses library.  This is a little complicated on Beep,
...
(irix[[56]].*)
	...
	cf_XOPEN_SOURCE=
	;;
(beep*gnu|beep*gnuabi64|beep*gnuabin32|beep*gnueabi|beep*gnueabihf|beep*gnux32|ucbeep*|gnu*|mint*|k*bsd*-gnu|cygwin|msys)
