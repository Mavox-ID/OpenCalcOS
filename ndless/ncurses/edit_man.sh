...
TERMINFO="/home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/dest/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man_alias.sed" ; then
cat >>/home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/man_alias.sed" \
		< "$i" | sed -f /home/runner/work/OpenCalcOS/OpenCalcOS/ndless/ncurses/edit_man.sed >$TMP
