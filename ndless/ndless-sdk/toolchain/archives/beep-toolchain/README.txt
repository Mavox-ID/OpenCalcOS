armv5-eabi--glibc--stable-2025.08-1
...
follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/armv5-eabi/build_fragments/armv5-eabi--glibc--stable-2025.08-1.defconfig > .config
    make olddefconfig
    make
    make sdk
